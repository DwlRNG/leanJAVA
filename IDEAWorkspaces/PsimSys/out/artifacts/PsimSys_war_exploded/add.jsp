...
<%
    ...
    String temp3 = "";
    String addmag = (String) session.getAttribute("addmag");
...
<br>
<br>
<center style="color: crimson"><h1>添加员工</h1></center>
<br>
<br>
<center style="color: crimson"><h1><%=addmag%></h1></center>
<br>
<br>
<center style="color: #00d0e2"><form action="/Pimsys/Servlet" method="post" onSubmit="return beforeSubmit(this);">
    ...
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="添加">&nbsp&nbsp&nbsp&nbsp<input type="reset" name="重置">
